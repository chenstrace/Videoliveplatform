...
public class SearchLiveOpenAdapter extends BaseAdapter {
    private Drawable mDefaultDrawable;
    private LayoutInflater mInflater;
    private ArrayList<SearchItemInfo> mList = new ArrayList();
    private OnSearchLiveOpenItemListener mListener;

    public interface OnSearchLiveOpenItemListener {
    ...
    SearchLiveOpenAdapter(Context context, OnSearchLiveOpenItemListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.liveitem.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                SearchLiveOpenAdapter.this.mListener.onSearchLiveOpenItemClick(items);
            }
        });
